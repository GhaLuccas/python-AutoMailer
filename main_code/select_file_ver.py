...
def criar_interface():
    ...
    tk.Label(root, text="Caminho Base NFe:").grid(row=2, column=0, padx=10, pady=10, sticky="e")
    ...
    tk.Label(root, text="Caminho Base SAT:").grid(row=3, column=0, padx=10, pady=10, sticky="e")
